    ...
    var EZP = {
        ...
        startZoom: function () {
            ...
            if (self.options.imageCrossfade) {
                if(self.$elem.parent().is('.zoomWrapper')){
                    self.$elem.unwrap();
            ...
            if (self.options.zoomType === 'lens') {
                self.zoomLens.css('background', self.options.zoomBackground + ' url("' + self.imageSrc + '")');
            }
            if (self.options.zoomType === 'window') {
                self.zoomWindow.css('background', self.options.zoomBackground + ' url("' + self.imageSrc + '")');
            }
            if (self.options.zoomType === 'inner') {
                self.zoomWindow.css('background', self.options.zoomBackground + ' url("' + self.imageSrc + '")');
            }
                ...
                self.zoomContainer.add(self.$elem).bind('wheel DOMMouseScroll MozMousePixelScroll', function (e) {
                    ...
                    if (theEvent / 120 > 0) {
                        ...
                        if (nextZoomLevel >= parseFloat(self.minZoomLevel)) {
                            ...
                            console.log('next ' + nextZoomLevel);
                            console.log('min ' + self.minZoomLevel);
                        }
                    }
                    else {
                        //scrolling down
                        ...
                        if ((!self.fullheight && !self.fullwidth) || !self.options.mantainZoomAspectRatio) {
                            ...
                            if (self.options.maxZoomLevel) {
                                if (nextZoomLevel <= self.options.maxZoomLevel) {
                                    self.changeZoomLevel(nextZoomLevel);
                                    console.log('next ' + nextZoomLevel);
                                    console.log('max ' + self.options.maxZoomLevel);
                                }
                            }
                            else {
                                //andy
        ...
        setWindowPosition: function (e) {
            ...
            if (!isNaN(self.options.zoomWindowPosition)) {
                ...
                switch (parseInt(self.options.zoomWindowPosition)) {
                    case 1: //done
        ...
        swapAction: function (smallimage, largeimage) {
            ...
            if (self.options.zoomType === 'lens') {
                self.zoomLens.css('background',  self.options.zoomBackground + ' url("' + largeimage + '")');
            }
            if (self.options.zoomType === 'window') {
                self.zoomWindow.css('background',  self.options.zoomBackground + ' url("' + largeimage + '")');
            }
            if (self.options.zoomType === 'inner') {
                self.zoomWindow.css('background',  self.options.zoomBackground + ' url("' + largeimage + '")');
            }
