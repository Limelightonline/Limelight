 ...
 *
 * @package TemplateMonster\ImageZoom\Block\Adminhtml\System\Config\Field
 */
    ...
    protected function _getExtraCss()
    {
        return <<<EOL
            <style>
                .field-color-picker {
                    cursor: pointer;
                    background: url({$this->getViewFileUrl('TemplateMonster_ImageZoom::images/colorpicker.png')})
                    no-repeat right;
                }
